...
// val list = new Cons(1, new Cons(2, new Cons(3, new Nil()))); // [1, 2, 3]
// val result = list.addAmount(5); // [6, 7, 8]
//
// [].addAmount(7); // []
Cons.prototype.addAmount = function(amount) {
    // From Java: 
    // return new Cons(head + amount, tail.addAmount(amount));
    return new Cons(this.head + amount, this.tail.addAmount(amount));
}
...
Nil.prototype.addAmount = function(amount) {
    return this;
    // return new Nil();
}
